    ...
    function initLanguageSystem() {
        ...
        function updateDocumentTitle(lang) {
            ...
            if (currentPage.includes('about.html')) {
                title = translations[lang].about + ' - ' + translations[lang].title;
            } else if (currentPage.includes('product.html')) {
                title = translations[lang].catalog + ' - ' + translations[lang].title;
            } else if (currentPage.includes('contact.html')) {
                title = translations[lang].contact + ' - ' + translations[lang].title;
            }
